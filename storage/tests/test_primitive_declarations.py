...
def test_postgres_supports_every_primitive():
    """Todas viáveis por docs/DESIGN.md; nenhuma conexão é aberta aqui."""
...
def test_scylla_does_not_support_intersect():
    """E-4 é inviável em Scylla por docs/DESIGN.md (sem primitiva de
...
def test_opensearch_does_not_support_prematerialized():
    """E-3 não tem sentido arquitetural em OpenSearch por docs/DESIGN.md —
