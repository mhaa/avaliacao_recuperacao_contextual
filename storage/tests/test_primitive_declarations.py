...
def test_opensearch_does_not_support_prematerialized():
    ...
    assert OpenSearchAdapter.supported_primitives == frozenset(
        {GET_CANDIDATES, GET_CANDIDATES_FILTERED, INTERSECT}
    )


def test_all_primitives_constant_matches_the_four_named_constants():
